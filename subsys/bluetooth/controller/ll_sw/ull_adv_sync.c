...
u8_t ll_adv_sync_param_set(u8_t handle, u16_t interval, u16_t flags)
{
	...
	if (!lll_sync) {
		...
		u8_t pri_len, pri_len_prev, sec_len, sec_len_prev;
		...
		u8_t *pri_dptr, *pri_dptr_prev;
		u8_t *sec_dptr, *sec_dptr_prev;
		struct pdu_adv_sync_info *si;
		struct lll_adv_aux *lll_aux;
		u8_t pri_idx, sec_idx, ad_len;
		struct lll_adv *lll;
		int err;
		...
		pri_dptr_prev = (u8_t *)pri_hdr + sizeof(*pri_hdr);
		...
		*(u8_t *)pri_hdr = 0U;
		...
		sec_dptr_prev = (u8_t *)sec_hdr + sizeof(*sec_hdr);
		...
		*(u8_t *)sec_hdr = 0U;
		...
		pri_len_prev = pri_dptr_prev - (u8_t *)pri_com_hdr_prev;
		pri_len = pri_dptr - (u8_t *)pri_com_hdr;
		...
		sec_len_prev = sec_dptr_prev - (u8_t *)sec_com_hdr_prev;
		sec_len = sec_dptr - (u8_t *)sec_com_hdr;
	...
	ter_dptr = (u8_t *)ter_hdr + sizeof(*ter_hdr);
	...
	*(u8_t *)ter_hdr = 0;
	...
	ter_len = ter_dptr - (u8_t *)ter_com_hdr;
	if (ter_len >
